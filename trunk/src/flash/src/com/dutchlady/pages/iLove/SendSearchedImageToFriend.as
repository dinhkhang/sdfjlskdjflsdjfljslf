package com.dutchlady.pages.iLove {
	 ...
	 * @author Hai Nguyen
	 */
	public class SendSearchedImageToFriend extends MovieClip {
		...
		public function SendSearchedImageToFriend() {
		...
		private function sendButtonClickHandler(event: MouseEvent): void {
			...
			if (resultsList.length > 0) {
				...
				service.sendToFriend(senderFullnameText.text, senderEmailText.text, profileId, "", receiverEmails);
